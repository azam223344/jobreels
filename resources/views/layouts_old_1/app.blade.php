            ...
            <ul class="flex-row nav navbar-nav">
                <li class="mr-auto nav-item"><a class="navbar-brand" href="{{url('/')}}/dashboard">
                        <div class="brand-logo">
                            <img src="{{asset('app-assets/images//logo/logo.png')}}" style='height:35px;'/>
            ...
            <ul class="mt-1 navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation" data-icon-style="">
                <li class="nav-item has-sub sidebar-group-active open"><a href="#"><i class="bx bx-lock"></i><span class="menu-title text-truncate" data-i18n="Dashboard">Privacy and Security Settings</span></a>
                    <ul class="menu-content">
                        ...
                        <li class=""><a class="d-flex align-items-center" href="{{url('/')}}/posts/flagged"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Solved Reports</span></a>
                        </li>
                        <li class=""><a class="d-flex align-items-center" href="{{url('/')}}/posts/flagged"><i class="bx bx-right-arrow-alt"></i><span class="menu-item text-truncate" data-i18n="eCommerce">Unsolved Reports</span></a>
                        </li>
