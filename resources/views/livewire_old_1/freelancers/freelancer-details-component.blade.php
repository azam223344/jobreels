                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-12">
                                            ...
                                            <span class="badge badge-{{$user->freelancer->verification_level == 'Verified' ? 'danger' : 'success'}}">{{$user->freelancer->verification_level == 'Verified' ? 'Unverified' : 'Verified'}}</span>
                                        </div>
                                        ...
                                        <div class="col-md-6 mt-1">
                                            <label>Phone: </label>
                                            <p> @if (!empty($user->phone) && is_numeric($user->phone))
                                        ...
                                        @if($user->freelancer->hourly_rate!=null)
                                        <div class="col-md-12 mt-1">
                                            <label>hourly rate</label>
                                            <p>{{$user->freelancer->hourly_rate ?? 'N/A'}}</p>
                                        </div>
                                        @endif
                                        @if($user->freelancer->skills_experience!=null)
                                        <div class="col-md-12 mt-1">
                                        ...
                                        <div class="col-md-12 mt-1">
                                            <label>skills</label>
                                            <p>{{ implode(' , ', json_decode($user->freelancer->skills_assessment)) ?? 'N/A' }}
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>{{ is_array(json_decode($post->skills)) ? implode(' , ', json_decode($post->skills)) : ($post->skills ?? 'N/A') }}
                                                </td>
