                    ...
                    <div class=" container row">
                        ...
                        <div class="col-6 mt-3 col-lg-6">
                            ...
                            @if (!empty($user->freelancer->photo))
                                <img src="{{ url('/') }}/uploads/{{ $user->freelancer->photo }}" width="50px" height="50px" />
                            @else
                                N/A
                            @endif
                        </div>
                        ...
                        <div class="col-6 mt-3 col-lg-6">
                            <b>Photo Government ID:</b>
                            @if (!empty($user->freelancer->photo_of_govt_id))
                                <img src="{{ url('/') }}/uploads/{{ $user->freelancer->photo_of_govt_id }}" width="50px" height="50px" />
                            @else
                                N/A
                            @endif
                        </div>
                        ...
                        <div class="col-6 mt-3 col-lg-6">
                            ...
                            @if (!empty($user->freelancer->bills))
                                <img src="{{ url('/') }}/uploads/{{ $user->freelancer->bills }}" width="50px" height="50px" />
                            @else
                                N/A
                            @endif
                        </div>
