...
@else --}}
    <img class="round" src="{{url('/logo.png')}}" alt="dummy avatar" height="40" width="40">
{{-- @endif</span> --}}
    </a>
    <div class="pb-0 dropdown-menu dropdown-menu-right">
        <a class="dropdown-item" href="{{url('/reset-password')}}"><i
            class="bx bx-refresh mr-50"></i> Reset Password</a>
