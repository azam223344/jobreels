                ...
                <div class="breadcrumbs-top">
                    ...
                    <div class="breadcrumb-wrapper d-none d-sm-block">
                        <ol class="p-0 pl-1 mb-0 breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Unsolve Flagged
                            </li>
                        </ol>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title">UnSolve Flagged Posts</h4>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @php $skillsdata=json_decode($post->skills)@endphp
                                            ...
                                            <td>
                                                ...
                                                <img src="{{ url('uploads/'.$post->user->profile_picture) }}" style="height: 60px; width: 60px; border-radius: 100%;" />
                                                <span style="margin-left: 10px;">{{ $post->user->first_name }} {{ $post->user->last_name }}</span>
                                            </div>
                                            @else
                                            N/A
                                        @endif</td>
