...
class FlaggedContentDetailComponent extends Component
{
    ...
    public function save()
    {
        ...
        $this->post->update();
         ...
         $body = "Action Taken on your Post {$this->post->title} by " . auth()->user()->name;
        ...
        Notifications::create([
            'title' => "Action Taken on the Post {$this->post->title} by " . auth()->user()->name,
            'notification' => "{$this->actionDescription} ",
