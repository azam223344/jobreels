...
Route::post('/convert-completed',[\App\Http\Controllers\Api\UsersController::class,'convertCompleted']);
Route::middleware(['auth'])->group(function () {
...
//Route::post('webhook', '\App\Http\Controllers\WebhookController');
Route::post('/webhook/stripe', [\Laravel\Cashier\Http\Controllers\WebhookController::class, 'handleWebhook']);
